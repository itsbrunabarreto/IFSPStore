...
namespace IFSPStore.App.Cadastros
{
    public partial class CadastroVenda : CadastroBase
    {
        ...
        #region Construtor
        public CadastroVenda(IBaseService<Venda> vendaService, IBaseService<Usuario> usuarioService, IBaseService<Cliente> clienteService, IBaseService<Produto> produtoService)
        {
